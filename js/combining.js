        ...
        var t = e(window).width(),
            ...
            i = function() {
                if (t < 991) {
                    if (0 == e(".mo-left .header-nav").children(".logo-header").length) {
                        ...
                        jQuery(".mo-left .header-nav").prepend(r), jQuery(".mo-left .header-nav .logo-header > a > img").attr("src", "images/logo-black.png"), jQuery(".mo-left.lw .header-nav .logo-header > a > img").attr("src", "images/logo-white.png")
                    }
            ...
            a = function(t) {
                var r, i = 0,
                    ...
                    a = new Array;
                e(t).each(function() {
                    if (r = e(this), e(r).height("auto"), topPostion = r.position().top, n != topPostion) {
                        for (currentDiv = 0; currentDiv < a.length; currentDiv++) a[currentDiv].height(i);
                        a.length = 0, n = topPostion, i = r.height(), a.push(r)
            ...
            l = function() {
                ...
                }), e = [], t < 991 && jQuery(".dzseth > div, .dzseth .img-cover, .dzseth .seth").each(function(e) {
        ...
        return {
            init: function() {
                ...
                jQuery(".box-hover").on("mouseenter", function() {
                    ...
                    function() {
                        e(".price-slide, .price-slide-2").length > 0 && e("#slider-range-2").slider({
                            range: !0,
                            min: 2,
                            max: 100,
                            type: "single",
                            ...
                            slide: function(t, r) {
                                var i = r.values[0],
                                    n = r.values[1];
                                e("#distance").val(i + "km - " + n + "km")
                            }
                        })
                    }(), t = parseInt(e(".onepage").css("height"), 10), e(".scroll").unbind().on("click", function(t) {
                        if (t.preventDefault(), "" !== this.hash) {
                            var r = this.hash,
                                i = e(r).offset().top,
                                n = parseInt(e(".onepage").css("height"), 10);
                            e("body").scrollspy({
                                target: ".navbar",
                                offset: n + 2
                            });
                        ...
                        target: ".navbar",
                        offset: t + 2
                    }), i(), r(), h = jQuery("#quik-search-btn"), d = jQuery("#quik-search-remove"), h.on("click", function() {
                    ...
                    })), jQuery(".dezPlaceAni").length && (e("input, textarea").on("focus", function() {
                    ...
                    })), o(), jQuery(document).on("change", ".btn-file :file", function() {
                        var e = jQuery(this),
                            t = e.get(0).files ? e.get(0).files.length : 1,
                            r = e.val().replace(/\\/g, "https://bizmap.dexignzone.com/").replace(/.*\//, "");
                        ...
                        if (jQuery(".sticky-header").length > 0) {
                            ...
                            e(window).scrollTop() > t.offset().top ? (t.addClass("is-fixed"), e(".header-transparent .container > .logo-header .logo, .header-transparent .container-fluid > .logo-header .logo").attr("src", "images/logo-black.png")) : (t.removeClass("is-fixed"), e(".header-transparent .container > .logo-header .logo, .header-transparent .container-fluid > .logo-header .logo").attr("src", "images/logo-white.png"))
                        }
                    }), l(), jQuery('iframe[src*="youtube.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery('iframe[src*="vimeo.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery("#image-gallery-mix").length && (jQuery(".gallery-filter").find("li").each(function() {
                    ...
                    }(c), e(".content-scroll").length && e(".content-scroll").mCustomScrollbar({
                        setWidth: !1,
                        setHeight: !1,
                        axis: "y"
                    }), s(), e(".item-close").on("click", function() {
                        e(this).closest(".cart-item").hide("500")
                    }), e(".cart-btn").unbind().on("click", function() {
                        e(".cart-list").slideToggle("slow")
                    }), e(".full-height").css("height", e(window).height()), n(), jQuery(window).on("resize", function() {
                        jQuery(".modal:visible").each(u), jQuery(".equal-wraper").length && a(".equal-wraper .equal-col"), o()
                    }), e("#lightgallery, .lightgallery").length > 0 && e("#lightgallery, .lightgallery").lightGallery({
                        selector: ".check-km",
                        loop: !0,
                        thumbnail: !0,
            ...
            load: function() {
                t > 1023 && jQuery(".bgeffect").length && skrollr.init({
                    ...
                    }), a(".equal-wraper .equal-col"), jQuery(".counter").length > 0 && jQuery(".counter").counterUp({
                        delay: 10,
                        time: 3e3
                    }),
                    function() {
                        if (jQuery("#masonry, .masonry").length) {
                            ...
                            jQuery(".card-container").length && t.imagesLoaded(function() {
                                t.masonry({
                                    gutterWidth: 15,
                                    isAnimated: !0,
                        ...
                        jQuery(".filters").length && jQuery(".filters").on("click", "li", function(r) {
                            r.preventDefault();
            ...
            resize: function() {
                t = e(window).width(), i(), r(), s(), l(), n()
            }
        }
    }();
    jQuery(document).ready(function() {
        t.init(), jQuery(".navicon").on("click", function() {
